...
lab3_vehicle_skyhook_sim.slx - simulates and compares passive and Skyhook system for vehicle model
 
lab3_vehicle_H_inf_ctrl.m - passive + Hinf for vehicle model of bounce and pitch control
lab3_vehicle_H_inf_sim.slx - simulates compares passive and Hinf control for vehicle model
...
lab3_vehicle_complete_sim.slx - simulates passive, skyhook and Hinf control for vehicle model
